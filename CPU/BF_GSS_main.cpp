...
int main() {
    ...
    string outputFilePathDC = "./result/spreads_bfgss_dc.txt";
    string outputFilePathDPC = "./result/spreads_bfgss_dpc.txt";
    string outputFilePathSC = "./result/spreads_bfgss_sc.txt";
