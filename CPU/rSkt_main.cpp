...
int main() {
    ...
    cout << endl;
    unsigned int v = 64;
    unsigned int unitNum = (100 * 1024 * 8) / (5 * v);
    cout << "Total space is " << 3.0 * (unitNum * 5 * v) / 8 / 1024 << "KB" << endl;
    rSkt* sktdc = new rSkt(unitNum, v);
    rSkt* sktdpc = new rSkt(unitNum, v);
    rSkt* sktsc = new rSkt(unitNum, v);
    cout << endl;
    ...
    string outputFilePathDC = "./result/spreads_rskt_dc.txt";
    string outputFilePathDPC = "./result/spreads_rskt_dpc.txt";
    string outputFilePathSC = "./result/spreads_rskt_sc.txt";
