...
int main() {
    ...
    unsigned int v = 4000;
    cout << "Total space is " << 3.0 * bitsNum / 8 / 1024 << "KB" << endl;
    Sketch* sktdc = new CSE(bitsNum, v);
    Sketch* sktdpc = new CSE(bitsNum, v);
    Sketch* sktsc = new CSE(bitsNum, v);
    cout << endl;
    ...
    string outputFilePathDC = "./result/spreads_cse_dc.txt";
    string outputFilePathDPC = "./result/spreads_cse_dpc.txt";
    string outputFilePathSC = "./result/spreads_cse_sc.txt";
